...
class HifiGANPreTrainedModel(PreTrainedModel):
...
class HifiGAN(HifiGANPreTrainedModel):
    def __init__(self, config: HifiGANConfig):
        super(HifiGAN, self).__init__(config)
        ...
        for i in range(len(self.ups)):
            ...
            for j, k in enumerate(resblock_kernel_sizes):
                self.resblocks.append(HifiGANResBlock(channels=ch, kernel_size=k, dilation=resblock_dilation_sizes, lrelu_slope=self.lrelu_slope))
